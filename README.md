...
项目代码遵循仓库内的 [LICENSE](LICENSE)。默认素材、示例素材、第三方角色/物品模组、外部字体/图标/音频和用户自行导入的素材可能有独立授权边界，分发或二次创作前请自行确认素材来源与授权条件
...
如果你发现问题或希望补充内容，可以通过 GitHub Issues 或 Pull Requests 交流；涉及 API Key、聊天记录、本机路径等敏感信息时，请先完成脱敏
